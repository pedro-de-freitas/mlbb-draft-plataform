...
import { CounterPanel } from "@/components/counters/counter-panel"
      ...
      <div className="space-y-6">
        <section className="rounded-3xl border border-zinc-800 bg-gradient-to-r from-zinc-900 via-zinc-950 to-zinc-900 p-5 shadow-2xl sm:p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-400 sm:text-base">
            Explore counters, matchups, sinergias e rotas de cada herói para
            draft competitivo, ranked e análise de composição.
          </p>
        </section>
